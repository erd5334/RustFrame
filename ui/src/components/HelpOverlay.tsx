...
function HelpOverlay({ onClose }: HelpOverlayProps) {
  const shortcuts = [
    { keys: "Cmd/Ctrl + Shift + R", action: "Start Capture (default)" },
    { keys: "Cmd/Ctrl + Shift + S", action: "Stop Capture (default)" },
    { keys: "Cmd/Ctrl + Shift + =", action: "Zoom In (default)" },
    { keys: "Cmd/Ctrl + Shift + Minus", action: "Zoom Out (default)" },
