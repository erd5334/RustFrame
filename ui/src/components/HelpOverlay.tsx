...
function HelpOverlay({ onClose }: HelpOverlayProps) {
  ...
  const shortcuts = [
    { keys: "Cmd/Ctrl + Shift + R", action: t('help.shortcut_start_capture') },
    { keys: "Cmd/Ctrl + Shift + S", action: t('help.shortcut_stop_capture') },
    { keys: "Cmd/Ctrl + Shift + =", action: t('help.shortcut_zoom_in') },
    { keys: "Cmd/Ctrl + Shift + Minus", action: t('help.shortcut_zoom_out') },
    { keys: "Esc", action: t('help.shortcut_close_dialogs') },
  ];
      ...
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">{t('help.subtitle')}</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <section className="bg-gray-700/30 rounded-xl p-5 border border-gray-600">
            ...
            <ol className="space-y-2 text-gray-300 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span dangerouslySetInnerHTML={{ __html: t('help.quick_start_step1') }} />
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold">2</span>
                <span>{t('help.quick_start_step2')}</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold">3</span>
                <span dangerouslySetInnerHTML={{ __html: t('help.quick_start_step3') }} />
              </li>
              <li className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold">4</span>
                <span dangerouslySetInnerHTML={{ __html: t('help.quick_start_step4') }} />
              </li>
              <li className="flex items-start gap-3">
                ...
                <span dangerouslySetInnerHTML={{ __html: t('help.quick_start_step5') }} />
              </li>
            </ol>
          </section>
          ...
          <section className="bg-gray-700/30 rounded-xl p-5 border border-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-white">{t('help.user_guide')}</div>
                  <div className="text-xs text-gray-400">{t('help.user_guide_desc')}</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-white">{t('help.troubleshooting')}</div>
                  <div className="text-xs text-gray-400">{t('help.troubleshooting_desc')}</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-white">{t('help.quick_start_link')}</div>
                  <div className="text-xs text-gray-400">{t('help.quick_start_link_desc')}</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium text-white">{t('help.github')}</div>
                  <div className="text-xs text-gray-400">{t('help.github_desc')}</div>
                </div>
              </button>
            </div>
          </section>
        ...
        <div className="px-6 py-4 border-t border-gray-700 bg-gray-800/50">
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-400" dangerouslySetInnerHTML={{ __html: t('help.press_esc') }} />
            <span className="text-gray-500">{t('help.version')}</span>
          </div>
        </div>
      </div>
    </div>
